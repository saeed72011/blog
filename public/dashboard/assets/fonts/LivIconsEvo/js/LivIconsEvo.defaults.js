...
function LivIconsEvoDefaults() {
	...
	var defaultOptions = {
		...
		pathToFolder: 'http://127.0.0.1:8000/dashboard/assets/fonts/LivIconsEvo/svg/', //the path from root of your site to folder with icons. Also may be as URL, like 'http://yoursite.com/path/to/LivIconsEvo/svg/'
